...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/KritinSynced/dropspace-ai.git
   cd dropspace-ai
   ```
...
4. **Launch the application:**
   ```bash
   flask run
   # Or simply use: python app.py
   ```

5. **Let's go:**
   Open your browser and navigate to `http://127.0.0.1:5000` to start using the interface!
